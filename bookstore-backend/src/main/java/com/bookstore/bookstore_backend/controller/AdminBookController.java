...
public class AdminBookController {
	...
	// GET /admin/books/all - returns all books including inactive
	@Operation(summary = "Get all books including inactive (admin)")
	@GetMapping("/books/all")
	public ResponseEntity<?> getAllBooksIncludingInactive() {
		return ResponseEntity.ok(bookService.getAllBooksIncludingInactive());
	}
